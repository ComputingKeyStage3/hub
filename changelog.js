...
window.CHANGES = [
  { v:"9.7.1", text:"Edit on a lesson now asks what you meant: the lesson itself, or a new version started from it. On a class that is doing a version it offers that version, the original, or a new version, and says what each one changes before you open it." },
